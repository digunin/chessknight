...
export default ({isPaused, onStart, onStop, onPause, onPlus, onMinus, speed})=>{
    return(
        <div className="controlpanel">
            <div onClick={onStart} className="controlbutton"><img src="/static/images/play.svg" alt=""/></div>
            <div onClick={onPause} className={isPaused?"controlbutton pauseactive":"controlbutton"}><img src="/static/images/pause.svg" alt=""/></div>
